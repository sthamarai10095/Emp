...
import com.vg.emp.heroku_292ea0bd78efe9c.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("heroku_292ea0bd78efe9c.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/heroku_292ea0bd78efe9c/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("heroku_292ea0bd78efe9c.EmployeeService")
